...
## the Sample has random decision-making and PointMassKinematics
##---------------------------------------------------------------------------------------------------------
class Sample:
	...
	# uses Code-Bullet: https://github.com/Code-Bullet/Smart-Dots-Genetic-Algorithm-Tutorial for the algorithm
...
##---------------------------------------------------------------------------
## use Point Mass Kinematics to model how a Sample interacts with it's Environment
##---------------------------------------------------------------------------
